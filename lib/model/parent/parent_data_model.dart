...
ParentDataModel parentDataModelFromJson(String str) => ParentDataModel.fromJson(json.decode(str));

String parentDataModelToJson(ParentDataModel data) => json.encode(data.toJson());
...
class ParentDataModel {
    ...
    factory ParentDataModel.fromJson(Map<String, dynamic> json) => ParentDataModel(
